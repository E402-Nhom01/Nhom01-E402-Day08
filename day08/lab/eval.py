...
from rag_answer_4 import rag_answer_4
import os
import json
...
VARIANT_CONFIG = {
    ...
    "label": "variant_hybrid_rerank_top20_k5",
}
...
def run_scorecard(
    ...
    for q in test_questions:
        ...
        if verbose:
            ...
            print(f"    [Faithful]  {faith['notes']}")
            print(f"    [Relevant]  {relevance['notes']}")
            print(f"    [Recall]    {recall['notes']}")
            print(f"    [Complete]  {complete['notes']}")
