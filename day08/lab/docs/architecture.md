...
| Rerank          | Thực hiện qua RRF     | Weighted fusion (Dense: 0.6, Sparse: 0.4)                |
| Query transform | Không                 | Giữ nguyên                                               |

**Lý do chọn variant này:**
Chọn **hybrid** vì tài liệu nội bộ chứa nhiều mã lỗi chuyên ngành (ERR-403, Jira project ID) và các thuật ngữ viết tắt (SLA P1, HR-2026). Việc chỉ dùng dense retrieval có thể gây nhầm lẫn ngữ nghĩa, trong khi hybrid giúp bắt chính xác các từ khóa kỹ thuật này.
